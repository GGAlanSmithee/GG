  ...
  var GG = function () {
      ...
      createClass(GG, [{
          ...
          value: function initSystems() {
              var movementComponents = [COMPONENT.TRANSFORM, COMPONENT.VELOCITY];

              var movement = function movement(entities, delta) {
                  var _iteratorNormalCompletion = true;
                  var _didIteratorError = false;
                  var _iteratorError = undefined;
              ...
              var render = function render(entities, _ref) {
                  ...
                  try {
                      for (var _iterator2 = entities[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                          var entity = _step2.value.entity;
